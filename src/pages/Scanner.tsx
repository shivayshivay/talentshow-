...
export default function Scanner() {
  ...
  const verifyId = async (id: string): Promise<ScanResult> => {
    ...
    if (error || !data) {
      console.error("Supabase error:", error, "ID attempted:", cleanId);
  ...
  useEffect(() => {
    ...
    const initScanner = async () => {
      // Use CDN global if available, otherwise dynamic import
  ...
  const handleManualVerify = async () => {
    ...
    // Support pasting full URL or just UUID
    let id = raw;
    try {
    ...
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        {result && (
          <div
            style={{
              ...
              border: `2px solid ${resultColors[result.status].border}`,
            }}
          >
            ...
            <div
              style={{
                ...styles.resultStatus,
                color: resultColors[result.status].color,
              }}
            >
              {result.status === "valid"
                ? "ENTRY GRANTED"
            ...
            {result.name && (
              <div style={styles.resultDetails}>
                <div>
                  <b style={{ color: "#a78bfa" }}>{result.name}</b>
                </div>
        ...
        <div style={styles.divider}>
          <span style={styles.dividerText}>or verify manually</span>
        </div>
